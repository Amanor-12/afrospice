...
const userSessionSchema = new Schema(
  {
    ...
    loginIp: { type: String, default: "", trim: true },
    lastSeenIp: { type: String, default: "", trim: true },
    loginUserAgent: { type: String, default: "", trim: true },
    lastSeenUserAgent: { type: String, default: "", trim: true },
    riskLevel: { type: String, required: true, default: "normal", trim: true, index: true },
    riskFlags: { type: [String], default: [] },
    anomalyCount: { type: Number, required: true, default: 0, min: 0 },
    anomalyDetectedAt: optionalDateField(),
  },
  {
    versionKey: false,
  }
